...
- A ``.pcf`` or ``.lpf`` constraints file. There should be exactly one constraints file per Apio project.
  The first constraints file that is found will be used for mapping wires to the physical FPGA pins for :ref:`cmd_build`.
